...
<div class="container mb-4">
    <div class="p-4 bg-primary text-white shadow-sm" style="border-radius: 15px; background: linear-gradient(90deg, #007bff, #00d1ff);">
        <h4 class="font-weight-bold mb-1"><i class="fas fa-tools mr-2"></i> Panel Manajemen Layanan</h4>
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3 class="text-white font-weight-bold">Kelola Layanan PS</h3>
                <button class="btn btn-primary px-4 shadow-sm" data-toggle="modal" data-target="#modalTambah">
                ...
                <div class="table-responsive">
                    <table class="table table-dark table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="py-3 px-4 font-weight-bold"><?= $l['jenis_ps']; ?></td>
                                <td class="py-3"><?= $l['tipe_room']; ?></td>
            ...
            <form action="/admin/tambah_layanan" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="jenis_ps" class="form-control bg-secondary text-white border-0" placeholder="Contoh: PlayStation 5" required>
                    </div>
                    <div class="form-group">
                        <label class="small">Tipe Room</label>
                        <input type="text" name="tipe_room" class="form-control bg-secondary text-white border-0" placeholder="Contoh: VIP (AC + Sofa)" required>
                    </div>
                    <div class="form-group">
                        <label class="small">Harga per Jam</label>
                        <input type="number" name="harga_per_jam" class="form-control bg-secondary text-white border-0" placeholder="Misal: 15000" required>
                    </div>
                </div>
                <div class="modal-footer border-secondary">
                    <button type="button" class="btn btn-outline-light px-4" data-dismiss="modal">Batal</button>
...
<style>
    /* Tambahan agar scrollbar table-responsive lebih smooth di dark mode */
    ...
    /* Pastikan container tidak meluap */
    .content-wrapper {
        overflow-x: hidden;
    }
</style>
