            ...
            <div class="col-lg-8 col-md-10">
                ...
                <div class="text-center mb-5">
                    <h2 class="font-weight-bold text-white text-glow">
                        KONFIRMASI <span class="text-gradient">BOOKING</span>
                    </h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text"
                                               class="form-control"
                                               value="<?= $layanan['jenis_ps']; ?> - <?= $layanan['tipe_room']; ?>"
                                               readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text"
                                               class="form-control"
                                               value="Rp <?= number_format($layanan['harga_per_jam'],0,',','.'); ?>"
                                               readonly>
                                    </div>
                                </div>
